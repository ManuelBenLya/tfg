...
import { actualizarUmbrales } from '@/services/servidorService';
...
export default function ModalUmbrales({ servidorId, nombreServidor, umbralesActuales, onClose, onUpdateSuccess }: UmbralesProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await actualizarUmbrales(servidorId, {
      ...
      console.error("Fallo de conexión o al guardar los umbrales", error);
    } finally {
      setIsSaving(false);
    }
  };
