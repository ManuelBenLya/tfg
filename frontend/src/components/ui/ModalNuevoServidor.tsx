...
import { crearServidor } from '@/services/servidorService';
...
export default function ModalNuevoServidor({ onClose, onSuccess }: ModalNuevoServidorProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const data = await crearServidor({
      ...
      const msg = err.response?.data?.detail || 'Error al registrar el servidor o fallo de conexión.';
      setError(msg);
    } finally {
